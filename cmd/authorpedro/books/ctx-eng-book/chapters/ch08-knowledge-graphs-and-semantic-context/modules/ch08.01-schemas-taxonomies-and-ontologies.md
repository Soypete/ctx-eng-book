...
- [See research/semantic-contracts.md] — Semantic contracts define what information means, valid interpretations, provenance, purpose-bound access, and behavioral guarantees. Knowledge graphs and ontologies are components, not substitutes: they provide identifiers, vocabulary, relationships, and constraints, but the contract adds obligations, guarantees, purpose, and behavior.