...
Every pipeline composition has measurable context cost that grows with complexity [Khattab et al., 2023](https://arxiv.org/abs/2310.14108). This is why context precision—the ratio of useful context to retrieved context—matters more than raw retrieval volume. Too much irrelevant context increases cost, latency, attention competition, and hallucination risk.