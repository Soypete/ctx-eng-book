...
- [Brandstetter et al., 2024](https://arxiv.org/abs/2412.10891): "Traditional RBAC models fail to capture the dynamic, multi-step nature of agent actions. Capability-based access provides fine-grained, revocable permissions tied to specific actions rather than static roles, enabling safer agent authorization in production systems."
