...
The performance impact is substantial. On the GBrain benchmark, a four-strategy hybrid (vector + BM25 + RRF + graph) achieves 49.1 P@5. Each component alone—ripgrep BM25 only, vector-only RAG, or hybrid without graph—sits around 18 P@5 [hybrid-retrieval-architectures](https://arxiv.org/abs/2408.10123). Graph traversal contributes +31 points. It's the difference between random performance and production-ready retrieval.
