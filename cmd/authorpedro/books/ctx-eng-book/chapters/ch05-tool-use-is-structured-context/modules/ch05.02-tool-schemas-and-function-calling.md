...
- [Kodathala, 2026](https://arxiv.org/abs/2607.05518) — Context-to-execution integrity: agents issue tool calls based on text they cannot verify; authorization failures range from 0-62% refusal rates
- [Zhang et al., 2026](https://arxiv.org/abs/2606.06054) — Trustworthy memory search: long-term memory as control channel susceptible to tool-call drift
