...
Over half (53%) of teams say they plan to deploy LLM apps into production in the next 12 months—however, nearly as many (43%) cite issues like accuracy of responses and hallucinations as barriers to implementation [Arize AI, 2024](https://arize.com/llm-observability).
