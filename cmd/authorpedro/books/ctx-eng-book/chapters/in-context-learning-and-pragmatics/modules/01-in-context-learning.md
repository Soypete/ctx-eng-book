...
```python
# Example: Tool schema with clear formatting — see examples/chapter-04-in-context-learning/06-tool-formatting.py
# Shows: Explicit tool descriptions that reduce formatting errors
```
...
```python
# Example: Structured output with validation — see examples/chapter-04-in-context-learning/07-structured-output.py
# Shows: Pydantic/enforced schema that guarantees parseable output
```
