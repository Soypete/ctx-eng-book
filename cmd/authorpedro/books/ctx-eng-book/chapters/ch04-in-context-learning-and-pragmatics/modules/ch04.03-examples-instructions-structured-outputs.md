...
These metrics let you objectively compare prompt variations. A prompt that extracts 90% of entities with 95% precision is objectively better than one that extracts 70% at 80% precision — regardless of how polished the output looks.
