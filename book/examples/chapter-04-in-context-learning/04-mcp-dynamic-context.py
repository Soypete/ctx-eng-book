...
# MCP is one protocol a host can use to expose tools and resources.
# Dynamic retrieval also requires a host loop, authorization, and tracing.
...
async def run_with_mcp_context(user_query: str):
    ...
    # The model can propose a tool call. The host authorizes and executes it.
